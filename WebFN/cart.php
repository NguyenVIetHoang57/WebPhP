            ...
            <section class="cart">
                <div class="container-top">
                    <div class="panel panel-primary">
                        ...
                        <h2 style="padding-top:200px" class="">Shopping Cart</h2>
                        ...
                        <table class="table table-bordered table-hover">
                            ...
                            <td width="100px">
                                <input type="number" name="num" id="num" value="' . $num . '" onchange="updateTotal(this.value, ' . $item['price'] . ')">
                            </td>
                            <td id="total">' . number_format($num * $item['price'], 0, ',', '.') . '<span> VNĐ</span></td>
                            <td>
                                <button class="btn btn-danger" onclick="editCart(' . $item['id'] . ')">Edit</button>
                            </td>
                            <td>
                        ...
                        <script>
                            function updateTotal(quantity, price) {
                                ...
                                document.getElementById("totalPrice").innerHTML = total.toLocaleString() + " VNĐ";
                            }
                        </script>
                                    ';
                                }
                        ...
                        <p>Total Price: <span class="red bold" id="totalPrice"><?= number_format($total, 0, ',', '.') ?><span> VNĐ</span></span></p>
                        <a href="checkout.php" onclick="checkLogin()"><button class="btn btn-success">Pay</button></a>
                    </div>
                </div>
            </section>
        </main>
