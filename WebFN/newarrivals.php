...
<section class="main">
            <section class="recently" style="padding-bottom: 50px;">
                ...
                <div class="product-recently">
                    <div class="row">
                        <?php
                        $sql = 'SELECT * from product, order_details, comments where comments.product_id = product.id AND order_details.product_id=product.id order by order_details.id DESC limit 8';
