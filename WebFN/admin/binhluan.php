...
<body>
    <ul class="nav nav-tabs">
        ...
        <li class="nav-item ">
            <a class="nav-link active" href="binhluan.php">Comments List</a>
        </li>
        <li class="nav-item ">
                    ...
                    <table class="table table-bordered table-hover">
                        ...
                        <tbody>
                            ...
                            try {
                                ...
                                $sql = "SELECT * from comments, product
                                where comments.product_id=product.id ORDER BY comments.id DESC limit $start,$limit";
                                $comments_List = executeResult($sql);
                                $total = 0;
                                $count = 0;
                                $index = 1;
                                foreach ($comments_List as $item) {
                                    echo '
                                        <tr style="text-align: center;">
                                            <td width="50px">' . (++$count) . '</td>
                                            <td class="b-500 red">' . $item['title'] . '</td>
