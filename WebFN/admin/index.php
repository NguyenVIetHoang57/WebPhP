    ...
    <div id="wrapper">
        <header>
            <ul class="nav nav-tabs">
                <li class="nav-item">
                    <a class="nav-link active" href="category/index.php">Statistical</a>
                </li>
                <li class="nav-item">
                ...
                <section class="dashboard">
                    <div class="table">
                        <div class="sp">
                            ...
                            ?>
                            <p><a href="product/">See details➜</a></p>
                        </div>
                        <div class="sp kh">
                            <p>Client</p>
                            <?php
                            ...
                            echo '<span>' . mysqli_num_rows($result) . '</span>';
                            ?>
                            <p><a href="userlist.php">See details➜</a></p>
                        </div>
                        <div class="sp dm">
                            <p>Category</p>
                            <?php
                            ...
                            echo '<span>' . mysqli_num_rows($result) . '</span>';
                            ?>
                            <p><a href="category/">See details➜</a></p>
                        </div>
                        <div class="sp dh">
                            <p>Order</p>
                            <?php
                            ...
                            echo '<span>' . mysqli_num_rows($result) . '</span>';
                            ?>
                            <p><a href="dashboard.php">See details➜</a></p>
                        </div>
                    </div>
                </section>
